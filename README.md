...
| `20260708_fam_external_lists.sql` | Tipo externa + external_url (carritos de tiendas) | ✅ Aplicada |
| `20260708_fam_activity_log.sql` | fam_activity: log real por triggers (incluye eliminaciones) + backfill | ✅ Aplicada |
